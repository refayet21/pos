...
import 'package:loyverspos/domain/repository.dart';
...
class ItemController extends GetxController {
  ...
  fetchAllStudent() async {
    var student = await itemRepository.getStudent();
    allStudent.value = student;
  }

  addStudent(ItemModel studentModel) {
    itemRepository.add(studentModel);
    fetchAllStudent();
  }

  updateStudent(ItemModel studentModel) {
    itemRepository.update(studentModel);
    fetchAllStudent();
  }
